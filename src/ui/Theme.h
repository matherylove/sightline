...
namespace Theme {
    ...
    // 0x0E=14, 0x11=17, 0x14=20  → 14/255=0.055, 17/255=0.067, 20/255=0.078
    ...
    static const ImVec4 COL_TEXT          = {0.910f, 0.933f, 0.949f, 1.0f}; // #E8EEF2
    static const ImVec4 COL_TEXT_DIM_V4   = {0.659f, 0.702f, 0.737f, 1.0f}; // #A8B3BC
    static const ImVec4 COL_TEXT_FAINT    = {0.435f, 0.478f, 0.514f, 1.0f}; // #6F7A83
